...
export const accountHolders: AccountHolderResponse[] = [
  ...
  { id: uid(102), display_name: "Lumière Studio", legal_name: "Lumière Studio SARL", entity_type: "business", country: "FR", kyc_status: "approved", risk_level: "low", email: "finance@lumiere.fr", inserted_at: iso(daysAgo(95)), updated_at: iso(daysAgo(8)), tenant_id: TENANT },
  { id: uid(103), display_name: "Nordic Freight AB", legal_name: "Nordic Freight Aktiebolag", entity_type: "business", country: "SE", kyc_status: "in_progress", risk_level: "medium", email: "kyc@nordicfreight.se", inserted_at: iso(daysAgo(20)), updated_at: iso(daysAgo(1)), tenant_id: TENANT },
  { id: uid(104), display_name: "Jin Wei", legal_name: "Jin Wei", entity_type: "individual", country: "SG", kyc_status: "approved", risk_level: "low", email: "jin.wei@example.com", inserted_at: iso(daysAgo(300)), updated_at: iso(daysAgo(40)), tenant_id: TENANT },
  { id: uid(105), display_name: "Cairo Trade Co", legal_name: "Cairo Trade Co", entity_type: "business", country: "EG", kyc_status: "on_hold", risk_level: "high", email: "ops@cairotrade.eg", inserted_at: iso(daysAgo(60)), updated_at: iso(daysAgo(3)), tenant_id: TENANT },
  ...
  { id: uid(107), display_name: "Maria González", legal_name: "Maria González", entity_type: "individual", country: "MX", kyc_status: "rejected", risk_level: "high", email: null, inserted_at: iso(daysAgo(10)), updated_at: iso(daysAgo(5)), tenant_id: TENANT },
